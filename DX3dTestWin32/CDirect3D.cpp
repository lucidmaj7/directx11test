...
HRESULT CDirect3D::LoadTexture(const WCHAR* strTextureFilePath)
{
	ScratchImage image;
	...
	hr= LoadFromWICFile(strTextureFilePath, WIC_FLAGS_NONE, nullptr, image);
